package chapter7.exercises.cardShufflingAndDealingE;
...
public class DeckOfCard {
    ...
    public Card[] evaluateAndDraw(DeckOfCard dealerDeck){
        Card[] dealerHand=dealHand();
        System.out.println("Dealer's hand (face down):");
        for (int index=0;index<5;index++){
            System.out.println("Card "+(index+1));
        }
        int drawCount= DeckOfCardTest.evaluateHand(dealerHand);
        System.out.println("Dealer draws "+drawCount+" cards.");
        for (int index=0;index<drawCount;index++){
            dealerHand[index]=dealerDeck.dealCard();
        }
        System.out.println("Dealer's hand (face up):");
        for (Card card :dealerHand){
            System.out.println(card);
        }

        System.out.println("Dealer's hand evaluation: "+ DeckOfCardTest.evaluateHandName(dealerDeck,dealerHand));
    return dealerHand;}
